...
INSERT INTO "user" (name, surname, email, password, join_date, last_login) VALUES
    ('Petra', 'Kos', 'petra.kos@hotmail.com', 'geslo',  CURRENT_DATE , CURRENT_DATE, null ),
    ('Miha', 'Novak', 'miha.novak@hotmail.com', 'novak',  CURRENT_DATE , CURRENT_DATE, null ),
    ('Dejan', 'Lavbič', 'dj.lavbi@hotmail.com', 'lavbi',  CURRENT_DATE , CURRENT_DATE, null ),
    ('Franci', 'Klavž', 'franci.klavz@hotmail.com', 'klavz',  CURRENT_DATE , CURRENT_DATE, null ),
    ('Janez', 'Kranjski', 'janez@hotmail.com', 'kranjski',  CURRENT_DATE , CURRENT_DATE, null );
...
INSERT INTO item (name, description, checked, created_date, list_id) VALUES
    ...
    ('Izdelek 2', 'shiny', FALSE, CURRENT_DATE, CURRENT_DATE ),
    ('Izdelek 3', 'niBBa', FALSE, CURRENT_DATE, CURRENT_DATE );

INSERT INTO category (name, description) VALUES
    ('Deli za avto', 'deli za avto lmao'),
    ('Sestavine', 'cooking dinner bitch');
